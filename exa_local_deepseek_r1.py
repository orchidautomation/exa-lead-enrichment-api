...
MODEL_CONFIGS = {
    ...
    # DeepSeek models
    "deepseek/deepseek-r1": {"max_tokens":8192, "use_json_mode": True},
...
agent = Agent(
    ...
    tools=[
        ExaTools(
            text_length_limit=4000,  # Reduced for faster processing
            num_results=10,  # Reduced for speed
            highlights=True,
            summary=True,
            show_results=True,
            use_autoprompt=True
...
if __name__ == "__main__":
    ...
    example_queries = [
        "superintendent + presidents  + directors + general leadership at oakridgecountryclub.org",  # Golf course superintendent
    ...
    # Improved query to catch all leadership positions including directors and professionals
